...
I'm passionate about software and design, and I enjoy building useful digital experiences. I'm always open to learning, collaborating, and exploring new opportunities. If you'd like to connect or discuss a project, feel free to get in touch. I'd love to hear from you.
        ...
        <div className={`hero-visual ${showContent ? 'hero-visual--show' : ''}`}>
          ...
          <div className="hero-badge hero-badge--code" style={{ '--dx': `${(mousePos.x / window.innerWidth - 0.5) * 20}px`, '--dy': `${(mousePos.y / window.innerHeight - 0.5) * 20}px` }}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>
            <span>Front-End</span>
          </div>
          <div className="hero-badge hero-badge--react" style={{ '--dx': `${((mousePos.x / window.innerWidth - 0.5) * -16)}px`, '--dy': `${((mousePos.y / window.innerHeight - 0.5) * -16)}px` }}>
          ...
          <div className="hero-visual-indicator">
