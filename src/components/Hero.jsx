  ...
  useEffect(() => {
    ...
    if (rolePhase === 'typing') {
      if (roleText.length < current.length) {
        const t = setTimeout(() => setRoleText(current.slice(0, roleText.length + 1)), 5)
      ...
      <div className="hero-inner">
        <div className={`hero-main ${showContent ? 'hero-main--show' : ''}`}>
          ...
          <h1 className="hero-name">
            <span className="hero-name-line hero-name-line--first">ABILASH</span>
          </h1>
...
I'm passionate about software and design, and I enjoy building useful digital experiences. I'm always open to learning, collaborating, and exploring new opportunities. If you'd like to connect or discuss a project, feel free to get in touch. I'd love to hear from you.
          ...
          <div className="hero-actions rv">
            <a href="mailto:mailtoabilashy@gmail.com" className="hero-btn hero-btn--primary">
        ...
        <div className={`hero-visual ${showContent ? 'hero-visual--show' : ''}`}>
          ...
          <div className="hero-badge hero-badge--code rv" style={{ '--dx': `${(mousePos.x / window.innerWidth - 0.5) * 20}px`, '--dy': `${(mousePos.y / window.innerHeight - 0.5) * 20}px` }}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>
            <span>Front-End</span>
          </div>
          <div className="hero-badge hero-badge--react rv" style={{ '--dx': `${((mousePos.x / window.innerWidth - 0.5) * -16)}px`, '--dy': `${((mousePos.y / window.innerHeight - 0.5) * -16)}px` }}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="2"/><path d="M12 2c5.5 0 10 4.5 10 10s-4.5 10-10 10S2 17.5 2 12 6.5 2 12 2z"/><path d="M12 2c-2 0-4 4.5-4 10s2 10 4 10 4-4.5 4-10-2-10-4-10z"/><path d="M2 12h20"/></svg>
            <span>React</span>
          </div>
          <div className="hero-badge hero-badge--node rv" style={{ '--dx': `${((mousePos.x / window.innerWidth - 0.5) * 14)}px`, '--dy': `${((mousePos.y / window.innerHeight - 0.5) * 14)}px` }}>
